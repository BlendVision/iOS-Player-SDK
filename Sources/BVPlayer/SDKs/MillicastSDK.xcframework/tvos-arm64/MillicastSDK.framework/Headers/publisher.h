 ...
 * When publishing, the SDK sets the AVAudioSession to the playAndRecord category, with voiceChat mode and allowBluetooth option.
 * If desired, the App can configure the AVAudioSession with its own settings.
 * For an example, please see how the Millicast iOS Sample App configures the AVAudioSession at:
 * https://github.com/millicast/Millicast-ObjC-SDK-iOS-Sample-App-in-Swift
 * @return false if an error occured, true otherwise.
 * @remarks returning true does not mean you are publishing.
 * You are publishing when the Listener's method onPublishing is called.
*/
